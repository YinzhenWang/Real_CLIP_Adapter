...
class BaseDataset(torch.utils.data.Dataset):
    ...
    def _get_text_segment(self, text_segment, max_len=None):
        ...
        full_tokens = tokens + [self.pad_token_id] * (max_len - num_tokens)
        ...
        return full_tokens, padding_mask, num_tokens, masked_tokens ###changed
    ...
    def _get_image_text_example(self, index: int, data: dict):
        ...
        language_tokens, padding_mask, _, masked_tokens = self._get_text_segment(text_segment)
        data["input_ids"] = language_tokens
        data["masked_ids"] = masked_tokens
        data["attention_mask"] = padding_mask
