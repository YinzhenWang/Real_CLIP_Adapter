...
if __name__ == "__main__":
    ...
    # model.cliptext.text_model.add_adapter(text_configname+"_t", config=configs[text_configname])
    # model.cliptext.text_model.train_adapter(text_configname+"_t")
    # model.cliptext.text_model.set_active_adapters(text_configname+"_t")
