...
if __name__ == "__main__":
  ...
  model.vision_model = CLIPVisionModel.from_pretrained(backbone)
  model.text_model = CLIPTextModel.from_pretrained(backbone)
  #### tokenizer = AutoTokenizer.from_pretrained(backbone)


  model.vision_model.load_adapter("./adapterv")
  model.vision_model.set_active_adapters("adapter_v")

  model.text_model.load_adapter("./adaptert")
  model.text_model.set_active_adapters("adapter_t")
